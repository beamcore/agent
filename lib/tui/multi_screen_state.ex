defmodule Beamcore.TUI.MultiScreenState do
  ...
  def put_active(%__MODULE__{active_screen: :f1} = state, active_state), do: %{state | f1_state: active_state}
  def put_active(%__MODULE__{active_screen: :f2} = state, active_state), do: %{state | f2_state: active_state}
  def put_active(%__MODULE__{active_screen: :f3} = state, active_state), do: %{state | f3_state: active_state}
