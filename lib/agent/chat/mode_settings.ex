defmodule Beamcore.Agent.Chat.ModeSettings do
  ...
  - `BEAMCORE_RESEARCH_PROVIDER`, `BEAMCORE_RESEARCH_MODEL`
  - `BEAMCORE_DEEP_RESEARCH_PROVIDER`, `BEAMCORE_DEEP_RESEARCH_MODEL`
  ...
  def normalize_mode(:f3), do: :research
  def normalize_mode(mode) when mode in [:agent, :chat, :research, :deep_research], do: mode
