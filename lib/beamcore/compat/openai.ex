defmodule Beamcore.OpenAI do
  @moduledoc """
  Legacy Mistral/OpenaiEx compatibility boundary.

  Universal chat execution does not route through this module; it uses
  `Beamcore.Provider.Router` and protocol adapters. This facade remains for
  backwards-compatible callers and Mistral-specific REST surfaces such as
  image generation that OpenaiEx does not expose.

  New provider-neutral runtime code must depend on `Beamcore.Provider`, not on
  `Beamcore.OpenAI`.
  """
