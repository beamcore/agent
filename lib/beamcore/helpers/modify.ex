defmodule Beamcore.Helpers.Modify do
  ...
  Eeva's runtime guards for the actual file reads and writes.
  """

  alias Beamcore.Agent.Tools.Eeva.Guard
  ...
  defp update(path, transform, metadata) do
    ...
    :ok = Guard.file(:write!, [path, updated])
