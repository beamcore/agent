...
supervision. It captures stdout/stderr, bounds large outputs, and blocks hard
runtime boundary violations such as internal storage access, unsafe runtime
modules, and shell interpreter entry points.
